...
<head>
    ...
    <title>${(systemSetting().title?? && systemSetting().title!="")?string(systemSetting().title , "后台系统")}</title>
    ...
    <link rel="stylesheet" href="${staticpath}/bootstrap/css/bootstrap.ext.css"  type="text/css">
    ...
    <link href="${staticpath}/css/base.css" rel="stylesheet" type="text/css">
    ...
    <link rel="stylesheet" href="${basepath}/static/css/manage.order.flow.css" />
