...
public class MailUtil {
	...
	public static void main(String[] args) {//huangf@spider.com.cn
		MailUtil mail =null;// = new MailUtil("543089122@qq.com","xxx@163.com","xxx", "smtp.163.com", "标题");
		//mail.attachfile("e:\\1.jpg");
		//mail.attachfile("e:\\bsa.js");
		mail = new MailUtil("andy_wu2012@163.com","testing_mail163@163.com","Pass1234","smtp.163.com");
		mail.startSend("测试标题", "测试内容");
...
//	String subject = null;
	...
	// 做一个可以传发件人等参数的构造
	public MailUtil(String to, String from,String password, String smtpServer) {
		// 初始化发件人、收件人、主题等
		this.to = to;
		this.from = from;
