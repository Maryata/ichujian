        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                ...
                <table class="table table-bordered">
                    <tr>
                        <td>未审核订单数：<a class="font-focus" href="${basepath}/manage/order/selectList?init=y&status=init">${systemManager().ordersReport.getNotPassCount()}</a></td>
                        <td>等待发货订单数：<a class="font-focus" style="color: #f50;" href="${basepath}/manage/order/selectList?init=y&status=pass">${systemManager().ordersReport.getWaitSendGoodsCount()}</a></td>
                    </tr>
                    <tr>
                        ...
                        <td>等待确认订单数：<a class="font-focus" style="color: #f50;" href="${basepath}/manage/order/selectList?init=y&status=temp">${systemManager().ordersReport.getTempCount()}</a></td>
                    </tr>
                </table>
				<!--
                <div class="alert alert-danger" style="margin-bottom: 2px;text-align: left;">
