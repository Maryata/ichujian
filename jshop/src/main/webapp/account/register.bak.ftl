				...
				<form role="form" id="form" method="post" class="form-horizontal" action="${basepath}/account/doRegister.html" theme="simple" >
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-6" style="float: right;">
				    	<img src="${basepath}/ValidateImage.do" id="codes2" onclick="javaScript:reloadImg2();" class="vcodeCss"></img>
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-md-6">
				    	<a target="_blank" class="form-control" href="${basepath}/help/zcxy.html">《myshop用户注册协议》</a>
				    </div>
				  </div>
