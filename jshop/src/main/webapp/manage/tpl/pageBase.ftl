...
<#--currentMenu:当前菜单项-->
<#macro pageBase currentMenu currentListUrl="" topMenu="" title="" jsFiles=[] cssFiles=[] staticJsFiles=[] staticCssFiles=[] checkLogin=true>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${basepath}/manage/user/home"><b>${systemSetting().title}</b></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                 <li><a href="${basepath}/index.html" target="_blank"><i class="glyphicon glyphicon-globe"></i> 访问站点</a></li>
                <li class="dropdown">
                ...
                <div class="col-lg-12">
                    <div class="navbar navbar-default">
                        <ol class="breadcrumb bootstrap-admin-breadcrumb">
                            ...
                            <#if currentListUrl?? && currentListUrl!="">&nbsp;&nbsp;&nbsp;&nbsp;<a href="${basepath}${currentListUrl}">返回</a></#if>
                        </ol>
                    </div>
                </div>
            </div>
