                    ...
                    <li>
                        ...
                        <#if menu.children?? && menu.children?size gt 0>
                            ...
                            <#list menu.children as menu>
                                <li>
                                    <a id="item_${menu.pid!"0"}_${menu.id!""}" <#if menu.id="69"> target="_blank" </#if> data-href="${menu.url}"  class="menu-item ${(currentMenu==menu.name)?string("active","")}"><i class="fa fa-files-o fa-fw"></i> ${menu.name!""}</a>
                                </li>
                            </#list>
                            </ul>
                        </#if>
