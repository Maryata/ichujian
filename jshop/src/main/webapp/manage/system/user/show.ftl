...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<table class="table table-bordered">
					...
					<tr>
						<td style="text-align: right;">阿智折扣率</td>
						<td style="text-align: left;">${e.discount!""}%</td>
					</tr>
					<tr>
						<td style="text-align: right;">非阿智折扣率</td>
						<td style="text-align: left;">${e.otherDiscount!""}%</td>
					</tr>
					<tr>
