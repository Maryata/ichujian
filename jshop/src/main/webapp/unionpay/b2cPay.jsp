...
<%@page import="net.jeeshop.core.util.StringUtil"%>
...
<%
	//提供默认值
 	...
 	String merId = "531101510299984";// 无卡
// 	String merId = "531101510291487";// B2C
// 	merId="000001509184276";//test
	...
	String host = "https://180.166.220.210";
	//前台接收地址
	String contextPath = request.getContextPath();
	String pageReturnUrl = host+contextPath+"/pgReturn.do";
	//后台接收地址
	String bgReturnUrl = host+contextPath+"/bgReturn.do";
%>
