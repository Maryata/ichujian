...
@Service
public class GameStrategyServiceImpl extends GameBaseService implements
		GameStrategyService {
	...
	public List<Map<String, Object>> raiders(long gid, int page, int rows) {
		...
		return _queryForList( "gameStrategy.raiders", parameterObject );
	}
	...
	public Map<String, Object> getRaidersById(long id, String uid, String source) {
		...
		List<Map<String, Object>> list = _queryForList( "gameStrategy.getRaidersById", parameterObject );
	...
	@Override
	public List<Map<String, Object>> search(int uid, String imei, String content, String type) {
		...
		// 现在查询是不分类型的，查询详细信息
		if ("0".equals(type)) {
			return _queryForList("ek_gameStrategy.search", content);
		}
