...
public class GameGiftServiceImpl extends GameBaseService implements GameGiftService {
	...
	public Map<String, Object> giftsIndex(long uid) {
		...
		List<Map<String,Object>> _l = getSqlMapClientTemplate().queryForList( "gameGift.index", TYPE );
		...
		if(null != _l && _l.size() >= 1) {
			...
			for ( int i = 0; i < _l.size(); ++i ) { // 这个不会多，不然查询不适合放在循环内
				...
				List<Map<String,Object>> l_category = _queryForList( "gameGift.findCategoryById", cid );
				if(l_category.size() >= 1) {
					...
					List<Map<String,Object>> _list = _queryForList( "gameGift.giftsDetail", parameterObject ) ;
	...
	public List<Map<String, Object>> gameGiftList(String uid, String pageIndex) {
		...
		List<Map<String, Object>> list = this.getSqlMapClientTemplate().queryForList("gameGift.gameGiftList", paramMap);
	...
	public List<Map<String, Object>> gameGift(String uid, String gid) {
		...
		// 查询当前用户是否领取过当前游戏
		List<Map<String, Object>> list = this.getSqlMapClientTemplate().queryForList("gameGift.gameGift", paramMap);
		this.userAction(list, uid);
		return list;
	}
...
//		return (String) this.getSqlMapClientTemplate().queryForObject("gameGift.usersGiftCode", paramMap);
		return this.getSqlMapClientTemplate().queryForList("gameGift.hasGotGame", paramMap);
	}
	...
	public List<Map<String, Object>> getGiftCode(String gid) {
		Map<String,Object> paramMap = new HashMap<String,Object>();
		paramMap.put("GID", gid);
		return this.getSqlMapClientTemplate().queryForList("gameGift.getGiftCode", paramMap);
	}
	...
	public void updateGiftCode(String cid) {
		...
		this.getSqlMapClientTemplate().update("gameGift.updateGiftCode", paramMap);
	}
	...
	public void addUserActionOfGift(String uid, String gid, String type, String code) {
		...
		this.getSqlMapClientTemplate().update("gameGift.updateUserActionOfGift", paramMap);
	}
	...
	public List<Map<String, Object>> giftDetail(String uid, String gid) {
		Map<String,Object> paramMap = new HashMap<String,Object>();
		paramMap.put("GID", gid);
		List<Map<String, Object>> list = this.getSqlMapClientTemplate().queryForList("gameGift.giftDetail", paramMap);
	...
	public List<Map<String, Object>> drawGiftCode(String gid) {
		...
		return this.getSqlMapClientTemplate().queryForList("gameGift.drawGiftCode", paramMap);
	}
	...
	public List<Map<String, Object>> usersGifts(String uid) {
		Map<String,Object> paramMap = new HashMap<String,Object>();
		paramMap.put("UID", uid);
		return this.getSqlMapClientTemplate().queryForList("gameGift.usersGifts", paramMap);
	}
