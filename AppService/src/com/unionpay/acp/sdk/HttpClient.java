...
public class HttpClient {
     ...
     * @throws Exception
     */
    public int send(Document document, String encoding) throws Exception {
        try {
            HttpURLConnection httpURLConnection = createConnectionXml(encoding);
            if (null == httpURLConnection) {
                throw new Exception("创建联接失败");
            }
            String sendData = document.getRootElement().asXML();
            LogUtil.writeLog("请求报文:[" + sendData + "]");
            this.requestServer(httpURLConnection, sendData,
                    encoding);
            this.result = this.response(httpURLConnection, encoding);
     ...
     */
    private HttpURLConnection createConnectionXml(String encoding) throws ProtocolException {
        HttpURLConnection httpURLConnection = null;
        try {
            httpURLConnection = (HttpURLConnection) url.openConnection();
        } catch (IOException e) {
            LogUtil.writeErrorLog("打开链接错误", e);
            return null;
        }
