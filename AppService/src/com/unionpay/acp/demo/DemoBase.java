...
public class DemoBase {
	...
	public static String backUrl = "http://www.ichujian.com/AppService/servlet/backRcvResponse";//受理方和发卡方自选填写的域[O]--后台通知地址

	//商户号
//	public static String merId = "777290058110048";
	public static String merId = "802440353110553";
   ...
   /**
    ...
    public static String getTxnAmt() {
        return "800";
    }
