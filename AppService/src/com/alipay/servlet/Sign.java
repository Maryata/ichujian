...
public class Sign extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		content = content.substring(0,content.indexOf("notify_url") - 1) + "&total_fee=" + "\"" + 9 + "\"" + content.substring(content.indexOf("notify_url") -1);
...
//		content = stringBuilder.toString();
	...
	//	resultMap.put("content",content);
        ...
        express = StrUtils.isEmpty(WeixinPayUtil.decode(express)) ? "ZTO" : WeixinPayUtil.decode(express);// 如果为空，默认物流ZTO
        ...
        try {
            exchangeService.save(phone, express, address, consignee, telNum, imei, pCode, ErpInfo.EXPRESS_CODE_ZTO, out_trade_no, uid, "2");
        } catch (Exception e) {
