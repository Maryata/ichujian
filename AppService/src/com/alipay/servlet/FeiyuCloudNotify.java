 ...
 */
public class FeiyuCloudNotify extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        LogUtil.writeLog("[飞语云-支付宝]接收后台通知开始");
        //获取支付宝POST过来反馈信息
...
//                String out_trade_no = params.get("out_trade_no");
                ...
                try {
                    ...
                    LogUtil.writeErrorLog("[飞语云]更新订单信息错误！", e);
                }
        ...
        LogUtil.writeLog("[飞语云-支付宝]接收后台通知结束");
    }
