 ...
 */
public class membraneNotify extends HttpServlet {
            ...
            if ("SUCCESS".equals(return_code)) {
                ...
                if ("SUCCESS".equals(result_code)) {
                    ...
                    if(sign.equals(root.elementText("sign"))) {
                        ...
                        // 更新订单信息
                        // 记录微信支付日志
                        Map<String,String> r = exchangeService.update(parameterMap);
                        //Map<String,String> r = exchangeService.updatePayStatus(parameterMap, "1","1");//(参数,支付类型,支付状态)支付
