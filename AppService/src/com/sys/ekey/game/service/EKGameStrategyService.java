...
public interface EKGameStrategyService {
	 ...
	 * @return
	 */
	List<Map<String,Object>> search(int uid, String imei, String content, String type,String gid);

	List<Map<String,Object>> list(int categoryId, int pageNumber, int pageSize);
}
