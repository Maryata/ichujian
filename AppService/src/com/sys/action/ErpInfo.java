...
//				result = HttpUtil.doPostJson(ERP_TEST_URL, json);
				...
				if("true".equals(StrUtils.emptyOrString(jsonResult.get("success")))){
					...
					log.info(">>>>>>>>>>>>>>>>>> add order to ERP failed platform_code:[{}] !!!",platform_code);
				}
    ...
    public static void main (String[] args) {
    	try {
			...
			info.put("method", ErpInfo.METHOD_ADD);
			info.put("vip_code","13916939517");// 2016-05-30 改为e键用户regId
			info.put("express_code","ZTO");
			info.put("receiver_province", "上海市");
			info.put("receiver_city", "上海市");
			info.put("receiver_district", "宝山区");
			info.put("receiver_address", "上海市宝山区云西路168弄3号202室");
			info.put("receiver_name", "李雯静");
			info.put("receiver_mobile", "13916939517");
			info.put("deal_datetime", "2016-04-05 11:49:19");
			info.put("platform_code", "040511491825848");
    		...
    		detail.put("qty", 1);
    		detail.put("price", 9);
    		detail.put("item_code", "C200A1M0028");
    		details.add(detail);
    		info.put("details", details);
