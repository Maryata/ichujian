...
public class SFTPChannel {
    ...
    public static void createCd(Map sftpDetails){
        ...
        try {
        	...
        	List<String> list = new ArrayList<String>(FileUtils.user_head.keySet());
        	...
        	for(String f : list){
        		...
        		chSftp.cd("..");
    			channel.openAndMakeDir(FileUtils.user_head.get("APP_ROOT")+FileUtils.user_head.get(f));
        	}
        	chSftp.quit();
    ...
    public static void main(String[] args) throws Exception {
    	FileUtils.init();
    	Map<String, String> sftpDetails = (Map<String, String>) FileUtils.fileConfgs.get("sftp");
