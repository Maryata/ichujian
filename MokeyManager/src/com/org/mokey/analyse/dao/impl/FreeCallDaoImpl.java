    ...
    public List<Map<String, Object>> selectCallDetailList(String sDate, String eDate, String phone,String fyid) {
        ...
        try {
            StringBuffer sql = new StringBuffer("SELECT TO_CHAR(T.C_DATE,'yyyy-MM-dd') AS DAY,T.C_FYACCID,TU.C_GLOBALMOBILEPHONE," +
                   " TO_CHAR(T.C_STIME / (1000 * 60 * 60 * 24) + TO_DATE('1970-01-01 08:00:00', 'YYYY-MM-DD HH:MI:SS'), 'YYYY-MM-DD HH24:MI:SS') AS EKSTIME," +
                   " TO_CHAR(T.C_ETIME / (1000 * 60 * 60 * 24) +  TO_DATE('1970-01-01 08:00:00', 'YYYY-MM-DD HH:MI:SS'), 'YYYY-MM-DD HH24:MI:SS') AS EKETIME," +
            ...
            sql.append(" ORDER BY DAY,TU.C_GLOBALMOBILEPHONE,TO_CHAR(T.C_STIME / (1000 * 60 * 60 * 24) + TO_DATE('1970-01-01 08:00:00', 'YYYY-MM-DD HH:MI:SS'), 'YYYY-MM-DD HH24:MI:SS') ");
