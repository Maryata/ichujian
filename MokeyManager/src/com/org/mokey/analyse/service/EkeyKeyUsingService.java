...
public interface EkeyKeyUsingService {
     ...
     * @return
     */
    List<List<Object>> carryOverUser(String userId, String sup, String sDate, String eDate);

    List<Map<String,Object>> stayUserList(String userId, String sup, String sDate, String eDate, List<String> ids);
}
