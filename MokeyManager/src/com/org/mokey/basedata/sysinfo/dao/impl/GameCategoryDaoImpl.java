...
public class GameCategoryDaoImpl implements GameCategoryDao {
	...
	private static final Logger LOGGER = Logger
			.getLogger(GameCategoryDaoImpl.class);
	...
	public List<Map<String, Object>> getGameCategoryList() {
		try {
			...
			LOGGER.error("GameCategoryDaoImpl.getGameCategoryList failed, e : " + e);
		}
		return null;
	}
	...
	public Map<String, Object> gameGiftCateList(int page) {
		...
		try {
			StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
					" FROM T_GAME_CATEGORY WHERE C_ISLIVE = 1 AND C_TYPE = '01'"); 
			...
			LOGGER.error("GameCategoryDaoImpl.gameGiftCateList failed, e : " + e);
		}
		return ret;
	}
	...
	public void addGameGiftCate(String id, String name, String logo,
		...
		try {
			...
			LOGGER.error("GameCategoryDaoImpl.addGameGiftCate failed, e : " + e);
		}
	}
	...
	public void delGameGiftCate(String id) {
		try {
			...
			LOGGER.error("GameCategoryDaoImpl.delGameGiftCate failed, e : " + e);
		}
	}
	...
	public Map<String, Object> getAllGame(int page, String cid, String name,
		...
		try {
			StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
					...
					" AND NOT EXISTS" +
					" (SELECT C.C_GID FROM T_GAME_APP_CATEGORY C WHERE" +
			...
			LOGGER.error("GameCategoryDaoImpl.getAllGame failed, e : " + e);
		}
		return ret;
	}
	...
	public Map<String, Object> getCurrCateGame(int page, String cid, String name) {
		...
		try {
			StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
					" FROM T_GAME_APP_CATEGORY T,T_GAME_APP_INFO G WHERE " +
			...
			LOGGER.error("GameCategoryDaoImpl.getCurrCateGift failed, e : " + e);
		}
		return ret;
	}
	...
	public int isExist(String cid, String gid) {
		try {
			...
			LOGGER.error("GameCategoryDaoImpl.isExist failed, e : " + e);
		}
		return 0;
	}
	...
	public void add(String cid, String gid, String order) {
		try {
			String sql = "INSERT INTO T_GAME_APP_CATEGORY" +
					" (C_ID, C_GID, C_CID, C_ORDER) VALUES" +
					" (SEQ_GAME_APP_CATEGORY.NEXTVAL,?,?,?)";
			jdbcTemplate.update(sql, new Object[]{gid,cid,order});
		} catch (Exception e) {
			LOGGER.error("GameCategoryDaoImpl.add failed, e : " + e);
		}
	}
	...
	public void update(String cid, String gid, String order) {
		try {
			String sql = "UPDATE T_GAME_APP_CATEGORY SET" +
					" C_ORDER = ? WHERE C_CID = ? AND C_GID = ?";
			jdbcTemplate.update(sql, new Object[]{order,cid,gid});
		} catch (Exception e) {
			LOGGER.error("GameCategoryDaoImpl.update failed, e : " + e);
		}
	}
	...
	public void remove(String cid, String gid) {
		try {
			String sql = "DELETE FROM T_GAME_APP_CATEGORY" +
					" WHERE C_CID = ? AND C_GID = ?";
			jdbcTemplate.update(sql, new Object[]{cid,gid});
		} catch (Exception e) {
			LOGGER.error("GameCategoryDaoImpl.remove failed, e : " + e);
		}
	}
