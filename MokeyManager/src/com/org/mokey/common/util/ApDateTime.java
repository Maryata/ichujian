...
public class ApDateTime {
	...
	public final static String DATE_TIME_HM = "yyyy-MM-dd HH:mm";
	 ...
	 * 
	 * @param firstDateMills
	 * @param secondDateMills
	 * @param type
	 *            H\M\W\M\Y
	 * @return
	 */
	 ...
	 * 
	 * @param dateTimeStr 本次执行时间
	 * @param strRegex 时间表达式
	 * @return   
	 */
...
//		log.debug(">>>> : " + str);
//
//		log.debug(getMonthBetween("2014-06","2014-05"));
		// String type = "20m";
		// String timeCount = "D";
		// int amount = 0;
		// String amountStr = type.substring(0,type.length()-1);
...
//		}
		...
		System.out.println(daysBetween("2016-05-10", "2016-05-17"));
	}
	 ...
	 * @throws ParseException 
	 */
	public static String getFirstDayOfMonth(String dateStr, String pattern) throws ParseException{
		
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat df = new SimpleDateFormat(pattern);
		Date currMonth = df.parse(dateStr);
        calendar.setTime(currMonth);
	 ...
	 * @return
	 */
	public static String getLastDayOfMonth(String dateStr, String pattern) throws ParseException{
		SimpleDateFormat df = new SimpleDateFormat(pattern);
	...
	public static String getFirstDayOfCurrMonth(){
		SimpleDateFormat sdf = new SimpleDateFormat(DATE_TIME_YMD); 
	 ...
	 * @throws ParseException
	 */
	public static int getCountOfMonth(String dateStr, String pattern) throws ParseException{
		int first = Integer.valueOf(getFirstDayOfMonth(dateStr, pattern));
		int last = Integer.valueOf(getLastDayOfMonth(dateStr, pattern));
		return (last - first + 1);
	}
	 ...
	 * @param year 指定年份
	 * @param week 指定周
     * @return 时间数组，包含两个元素。0：该周的开始日期，1：该周的结束日期
     */
	public static Date[] dayOfWeekOfYear(int year, int week) {
	 ...
	 * @throws ParseException
     */
	public static int daysBetween(String sDate,String eData){
