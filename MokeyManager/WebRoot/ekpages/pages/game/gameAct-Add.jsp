...
$(function(){
	...
	KindEditor.ready(function(K) {
		window.editor_content = K.create('#depict', {
            ...
            uploadJson : "${pageContext.request.contextPath}/KindEditServlet.do?ekey=3&type=gameChild/activity/html&id="+$("#newId").val(),
...
//		});
		$("#form1").attr("action","${pageContext.request.contextPath }/basedata/ekey/eKGameActAction!saveGameAct.action");
	}
	return _flag;
}
...
function uploadFile(btn,fileId,baseId) {
	...
	$.ajaxFileUpload( {// ekey : 1.首页，2.活动，3.游戏
		url : "${pageContext.request.contextPath }/LogoUploadServlet.do?ekey=3&type=gameChild/activity/logo&id="+$("#newId").val(),//用于文件上传的服务器端请求地址
