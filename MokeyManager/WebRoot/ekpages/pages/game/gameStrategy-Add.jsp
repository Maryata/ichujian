...
//         cssPath : "${pageContext.request.contextPath}/js/kindeditor/themes/simple/kindimg.css",
        uploadJson : "${pageContext.request.contextPath}/KindEditServlet.do?ekey=3&type=gameChild/strategy/html&id="+$("#newId").val(),
...
//		});
		$("#form1").attr("action","${pageContext.request.contextPath }/basedata/ekey/eKGameStrategyAction!saveGameStrategy.action");
	}
	return _flag;
}
...
function uploadFile(btn,fileId,baseId) {
	...
	$(btn).html("uploading...");
	$.ajaxFileUpload( {
		url : "${pageContext.request.contextPath }/LogoUploadServlet.do?ekey=3&type=gameChild/strategy/logo&id="+$("#newId").val(),//用于文件上传的服务器端请求地址
...
<table width="98%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="62.7%" class="tz_crumbs"><img src="${pageContext.request.contextPath}/images/crumbs.jpg" width="9" height="9" /> 
    	<s:if test="#request.flag==1">系统信息 -&gt; 3号键管理 -&gt; 攻略管理-&gt; 添加攻略</s:if>
		<s:else>系统信息 -&gt; 3号键管理 -&gt; 攻略管理-&gt; 编辑攻略</s:else>
   	</td>
  </tr>
</table>
...
<table width="80%"  border="0" align="center" cellpadding="0" cellspacing="1" class="tbg sortable">
  ...
  <tr>
  	<td width="8%"  height="23" class="biaodan-top" align="left">攻略名称：</td>
 	...
 	<td width="8%"  height="23" class="biaodan-top" align="left">攻略LOGO：</td>
