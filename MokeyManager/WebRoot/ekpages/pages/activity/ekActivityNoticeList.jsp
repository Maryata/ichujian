...
<table width="98%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="62.7%" class="tz_crumbs"><img src="${pageContext.request.contextPath}/images/crumbs.jpg" width="9" height="9" /> 系统信息 -&gt; e键管理 -&gt; 活动注意事项维护 </td>
  </tr>
</table>

<form id="form1" method="post" action="${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!toAdd.action">
...
$(function(){
	// 查询应用总数
	$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!ekActivityNoticeList.action",
		function(data){
			...
			if(count != 0){
				...
				// 分页显示活动注意事项
				getCatePage("${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!ekActivityNoticeList.action");
			}
	});
	// 查询活动注意事项(第一页)
	$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!ekActivityNoticeList.action",
...
function deleteCate(cid){
    ...
    if(flag){
		$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!toDel.action",
...
function modifyCate(cid,cname,logo){
	$("#form2").attr("action","${pageContext.request.contextPath}/basedata/ekey/EKActivityNoticeAction!toUpdate.action");
	$("#editId").val(cid);
	$("#editName").val(cname);
	$("#editLogo").val(logo);
	$("#form2").submit();
