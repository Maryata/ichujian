...
function deleteCol(cid){
    ...
    if(flag){
		$.post("${pageContext.request.contextPath}/basedata/h5GameColAction!h5DeleteCol.action",
...
function modifyCol(cid,cname){ 
	var answer=window.open("${pageContext.request.contextPath}/basedata/pages/h5GameCol-modify.jsp?cid="+cid+"&cname="+cname,
		"修改合集","height=150, width=350, top=300, left=450, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no"); 
} 
// 有效性
function isValid(cid,islive){
	$.post("${pageContext.request.contextPath}/basedata/h5GameColAction!h5IsValid.action",
...
function handle(cid,cname){
	var answer=window.open("${pageContext.request.contextPath}/basedata/pages/h5GameCol-handle.jsp?cid="+cid+"&cname="+cname,
			"游戏合集分类","height=600, width=650, top=50, left=450, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no"); 
}
// 校验新增合集名
function checkAdd(){
	...
	$.post("${pageContext.request.contextPath}/basedata/h5GameColAction!h5AddCol.action",
...
<table width="98%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <!--2015-4-29新样式，面包屑-->
    <td width="62.7%" class="tz_crumbs"><img src="${pageContext.request.contextPath}/images/crumbs.jpg" width="9" height="9" /> 系统信息 -&gt; 3号键管理 -&gt; H5游戏合集维护 </td>
  </tr>
</table>

<form id="form2" method="post" action="${pageContext.request.contextPath}/basedata/h5GameColAction!h5AddCol.action">
...
<table id="mytable" width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" class="tbg sortable">
  <tr class="biaodan-top">
    ...
    <td width="20%">操作</td>
  	...
  	<s:iterator var="col" value="h5GameCol">
	<tr class="biaodan-q">
