...
function infoList(){
	...
	// 查询总数
	$.post("${pageContext.request.contextPath}/basedata/gameGiftAction!getTotal.action",{gid:gid,name:name,gName:gName},
		function(data){
			var json = $.parseJSON(data);
			$("#total").val(json);
			// 分页查询
			getGameGiftPage("${pageContext.request.contextPath}/basedata/gameGiftAction!gameGiftList.action",gid,name,gName);
	});
	// 查询所有
	$.post("${pageContext.request.contextPath}/basedata/gameGiftAction!gameGiftList.action",{gid:gid,name:name,gName:gName},
		function(data){
			json = $.parseJSON(data);
			$("#mytable").empty();
			$(json).each(function(){
...
function deleteInfo(id){
    ...
    if(flag){
		$.post("${pageContext.request.contextPath}/basedata/gameGiftAction!deleteGameGift.action",
				{id:id},function(data){
