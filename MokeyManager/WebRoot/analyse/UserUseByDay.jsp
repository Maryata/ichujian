...
<body >
<form name="form1" method="post" action="<%=request.getContextPath()%>/analyse/userUseInfo!getUserUseByDay.action">
<table width="100%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="../image/dian.jpg" width="9" height="9" /> 运营分析 -&gt; 用户使用情况 -&gt; 日使用情况</td>
  </tr>
</table>
