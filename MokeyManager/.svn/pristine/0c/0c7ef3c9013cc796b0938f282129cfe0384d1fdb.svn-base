 ...
 */
@Repository
public class EKGameStrategyCateDaoImpl implements EKGameStrategyCateDao {
    private static final Logger LOGGER = Logger.getLogger(EKGameStrategyCateDaoImpl.class);
    ...
    public List<Map<String, Object>> getGameStrategyCateList() {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.getGameStrategyCateList failed, e : " + e);
        }
        return null;
    }
    ...
    public Map<String, Object> gameGiftStrategyCateList(int page) {
        ...
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.gameGiftStrategyCateList failed, e : " + e);
        }
        return ret;
    }
    ...
    @Override
    // 新增游戏游戏分类
    public void addGameGiftStrategyCate(String id, String name, String logo,
        ...
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.addGameGiftStrategyCate failed, e : " + e);
        }
    }
    ...
    @Override
    // 更新游戏游戏分类
    public void updateGameGiftStrategyCate(String id, String name, String logo,
                                   String order, String modifier) {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.delGameGiftStrategyCate failed, e : " + e);
        }
    }
    ...
    public Map<String, Object> getAllGame(int page, String cid, String name,
        ...
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.getAllGame failed, e : " + e);
        }
        return ret;
    }
    ...
    public Map<String, Object> getCurrStrategyCateGame(int page, String cid, String name) {
        ...
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.getCurrStrategyCateGift failed, e : " + e);
        }
        return ret;
    }
    ...
    public int isExist(String cid, String sid) {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.isExist failed, e : " + e);
        }
        return 0;
    }
    ...
    public void add(String cid, String sid, String order) {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.add failed, e : " + e);
        }
    }
    ...
    public void update(String cid, String sid, String order) {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.update failed, e : " + e);
        }
    }
    ...
    public void remove(String cid, String sid) {
        try {
            ...
            LOGGER.error("EKGameStrategyCateDaoImpl.remove failed, e : " + e);
        }
    }
