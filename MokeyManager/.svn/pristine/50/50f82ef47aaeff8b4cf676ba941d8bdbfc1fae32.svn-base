...
<table width="98%" height="35"  border="0" align="center" cellpadding="1" >
	<tr>
		<td align="left" class="jg_fc">活动头条&nbsp;-&gt;&nbsp;</td>
	</tr>
</table>
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tbg">
	<tr width="300px;">
		<td width="50%">切换数据</td>
		<td width="50%">
			<select style="width:100%;border:none;hight:100%;" id="type" name="type">
...
<script src="${pageContext.request.contextPath}/ekpages/js/ekActivityHeadLine-handle.js" type="text/javascript"></script>
<script type="text/javascript">
