		...
		$.post("${pageContext.request.contextPath}/basedata/ekey/eKFreeCallAction!freeCallList.action",{fyAccountId:fyAccountId,phone:phone,status:status,sdate:sdate,edate:edate},
				function(data){
					...
					$(list).each(function(){
						...
						_s += "<input type='button' value='ID查询' class='butt' id='"+this.C_ID+"' onClick='selectOnline("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\",\""+this.C_GLOBALMOBILEPHONE+"\","+1+")'/>";
						_s += "<input type='button' value='e键账号查询' class='butt' id='"+this.C_ID+"' onClick='selectOnline("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\",\""+this.C_GLOBALMOBILEPHONE+"\","+2+")'/>";
						_s += "<input type='button' value='禁用并删除' class='butt'  onClick='deleteFy("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\",\""+this.C_GLOBALMOBILEPHONE+"\",\""+this.C_STATUS+"\")'/>";
					...
					$.post(url,{page:e.curr,fyAccountId:fyAccountId,phone:phone,status:status,sdate:sdate,edate:edate},
							function(data){
								...
								$(list).each(function(){
									...
									_s += "<input type='button' value='在线状态' class='butt' onClick='selectOnlineStatus("+this.C_ID+",\""+this.C_FYACCOUNTID+"\")'/>";
									_s += "<input type='button' value='ID查询' class='butt' id='"+this.C_ID+"' onClick='selectOnline("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\","+1+")'/>";
									_s += "<input type='button' value='e键账号查询' class='butt' id='"+this.C_ID+"' onClick='selectOnline("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\","+2+")'/>";
									_s += "<input type='button' value='禁用并删除' class='butt'  onClick='deleteFy("+this.C_ID+",\""+this.C_FYACCOUNTID+"\",\""+this.C_APPACCOUNTID+"\",\""+this.C_GLOBALMOBILEPHONE+"\",\""+this.C_STATUS+"\")'/>";
