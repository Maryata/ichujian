 ...
 */
@Repository
public class EKGameCategoryDaoImpl implements EKGameCategoryDao {

    private static final Logger LOGGER = Logger.getLogger(EKGameCategoryDaoImpl.class);
    ...
    public List<Map<String, Object>> getGameCategoryList() {
        try {
            ...
            LOGGER.error("EKGameCategoryDaoImpl.getGameCategoryList failed, e : " + e);
        }
        return null;
    }
    ...
    public Map<String, Object> gameGiftCateList(int page) {
        ...
        try {
            StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
                    " FROM T_EK_GAME_CATEGORY WHERE C_ISLIVE = 1 AND C_TYPE = '01'");
            ...
            LOGGER.error("EKGameCategoryDaoImpl.gameGiftCateList failed, e : " + e);
        }
        return ret;
    }
    ...
    public void addGameGiftCate(String id, String name, String logo,
        ...
        try {
            ...
            LOGGER.error("EKGameCategoryDaoImpl.addGameGiftCate failed, e : " + e);
        }
    }
    ...
    public void delGameGiftCate(String id) {
        try {
            ...
            LOGGER.error("EKGameCategoryDaoImpl.delGameGiftCate failed, e : " + e);
        }
    }
    ...
    public Map<String, Object> getAllGame(int page, String cid, String name,
        ...
        try {
            StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
                    ...
                    " AND NOT EXISTS" +
                    " (SELECT C.C_GID FROM T_EK_GAME_APP_CATEGORY C WHERE" +
            ...
            LOGGER.error("EKGameCategoryDaoImpl.getAllGame failed, e : " + e);
        }
        return ret;
    }
    ...
    public Map<String, Object> getCurrCateGame(int page, String cid, String name) {
        ...
        try {
            StringBuffer sql = new StringBuffer("SELECT COUNT(1)" +
                    " FROM T_EK_GAME_APP_CATEGORY T,T_GAME_APP_INFO G WHERE " +
            ...
            LOGGER.error("EKGameCategoryDaoImpl.getCurrCateGift failed, e : " + e);
        }
        return ret;
    }
    ...
    public int isExist(String cid, String gid) {
        try {
            String sql = "SELECT COUNT(1) FROM T_EK_GAME_APP_CATEGORY " +
                    " WHERE C_CID = ? AND C_GID = ?";
            return jdbcTemplate.queryForObject(sql, new Object[]{cid, gid}, Integer.class);
        } catch (Exception e) {
            LOGGER.error("EKGameCategoryDaoImpl.isExist failed, e : " + e);
        }
        return 0;
    }
    ...
    public void add(String cid, String gid, String order) {
        try {
            String sql = "INSERT INTO T_EK_GAME_APP_CATEGORY" +
                    " (C_ID, C_GID, C_CID, C_ORDER) VALUES" +
                    " (SEQ_EK_GAME_APP_CATEGORY.NEXTVAL,?,?,?)";
            jdbcTemplate.update(sql, new Object[]{gid, cid, order});
        } catch (Exception e) {
            LOGGER.error("EKGameCategoryDaoImpl.add failed, e : " + e);
        }
    }
    ...
    public void update(String cid, String gid, String order) {
        try {
            String sql = "UPDATE T_EK_GAME_APP_CATEGORY SET" +
                    " C_ORDER = ? WHERE C_CID = ? AND C_GID = ?";
            jdbcTemplate.update(sql, new Object[]{order, cid, gid});
        } catch (Exception e) {
            LOGGER.error("EKGameCategoryDaoImpl.update failed, e : " + e);
        }
    }
    ...
    public void remove(String cid, String gid) {
        try {
            String sql = "DELETE FROM T_EK_GAME_APP_CATEGORY" +
                    " WHERE C_CID = ? AND C_GID = ?";
            jdbcTemplate.update(sql, new Object[]{cid, gid});
        } catch (Exception e) {
            LOGGER.error("EKGameCategoryDaoImpl.remove failed, e : " + e);
        }
    }
