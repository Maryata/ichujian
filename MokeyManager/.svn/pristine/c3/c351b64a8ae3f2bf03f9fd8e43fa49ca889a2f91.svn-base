...
import com.org.mokey.basedata.sysinfo.dao.EKMessageDao;
...
@Repository
public class EKMessageDaoImpl implements EKMessageDao {
    ...
    public void save (Map<String, Object> map) {
        ...
        jdbcTemplate.update(updateSql,new Object[] {uid});
    }
}
