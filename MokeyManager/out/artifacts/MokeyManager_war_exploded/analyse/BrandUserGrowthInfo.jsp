...
<body >
<form name="form1" method="post" action="<%=request.getContextPath()%>/anaylse/brandUserGrowth!getUserGrowthList.action">
<table width="100%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="../image/dian.jpg" width="9" height="9" /> 运营分析 -&gt; 用户增长情况 -&gt; 按品牌统计日增长情况 </td>
  </tr>
</table>
  ...
  <tr>
    <td>
      <table width="100%"  border="0" cellspacing="1" cellpadding="2">
        <tr> 
         <td height="23" class="biaodan-top" align="left">开始日期：</td>
         <td class="biaodan-q">
         	<input class="Wdate" type="text" onClick="WdatePicker()" id="startdate" name="startdate" value="<%=request.getAttribute("startdate")%>" > 
         </td>
          <td height="23" class="biaodan-top" align="left">结束日期：</td>
         <td class="biaodan-q">
         	<input class="Wdate" type="text" onClick="WdatePicker()" id="enddate" name="enddate" value="<%=request.getAttribute("enddate")%>" >
         </td>
