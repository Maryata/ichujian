...
// $(function(){
// 	游戏分类下拉框
// 	$.post("${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!getColById.action",function(data){
// 		json = eval("("+data+")");
...
function deleteCol(cid){
    ...
    if(flag){
		$.post("${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!deleteCol.action",
...
function isvalid(cid,islive){
	$.post("${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!isvalid.action",
...
function handle(cid,cname,type){
	...
	$("#addCname").val(cname);
	$("#type").val(type);
	$("#form1").attr("action","${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!toHandle.action");
	$("#form1").submit();
	/*
...
function checkAdd(){
	...
	$.post("${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!addCol.action",
...
<!-- <form name="form1" method="post" action="${pageContext.request.contextPath}/basedata/ekey/eKGameColAction!gameCol.action"> -->
