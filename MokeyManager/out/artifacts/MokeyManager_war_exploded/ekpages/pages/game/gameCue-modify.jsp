...
function submitt(){
	...
	$.post("${pageContext.request.contextPath}/basedata/ekey/eKGameCueAction!modifyCue.action",{cid:cid,title:title,islive:islive},function(data){
...
<form id="updateForm" method="post">
	<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" class="tbg sortable">
	  <tr class="biaodan-q">
	    ...
	    <td width="5%"  height="23" class="biaodan-top" align="left">提示内容：</td>
	    <td width="19.6%" class="biaodan-q" align="center">
	    	<input type="text" id="title" name="title" value="${param.ctitle }" style="border:none; color:#636775; width:100%; height:30px;" />
	    </td>
	  </tr>
	  <tr class="biaodan-q">
