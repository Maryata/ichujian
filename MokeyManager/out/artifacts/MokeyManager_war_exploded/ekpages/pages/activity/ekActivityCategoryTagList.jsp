...
<table width="98%" height="35"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="62.7%" class="tz_crumbs"><img src="${pageContext.request.contextPath}/images/crumbs.jpg" width="9" height="9" /> 系统信息 -&gt; e键管理 -&gt; 活动标签维护 </td>
  </tr>
</table>

<form id="form1" method="post" action="${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!toAdd.action">
...
$(function(){
	// 查询应用总数
	$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!ekActivityCategoryTagList.action",
		function(data){
			...
			if(count != 0){
				...
				// 分页显示活动标签
				getCatePage("${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!ekActivityCategoryTagList.action");
			}
	});
	// 查询活动标签(第一页)
	$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!ekActivityCategoryTagList.action",
		function(data){
			...
			$(list).each(function(){
				...
				_s += "<td align='center'><input type='button' value='修 改' class='butt' onClick='modifyCate("+this.C_ID+",\""+this.C_NAME+"\",\""+this.C_IMG+"\")'/>";
...
function deleteCate(cid){
    ...
    if(flag){
		$.post("${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!toDel.action",
...
// 修改
function modifyCate(cid,cname,logo){
	$("#form2").attr("action","${pageContext.request.contextPath}/basedata/ekey/EKActivityCategoryTagAction!toUpdate.action");
	$("#editId").val(cid);
	$("#editName").val(cname);
	$("#editLogo").val(logo);
	$("#form2").submit();
