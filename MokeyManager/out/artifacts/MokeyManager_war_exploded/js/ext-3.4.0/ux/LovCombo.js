		...
		if (v) {
			...
			if(this.selectall){
				if(this.getCheckedValue().split(",").length == this.store.getCount()){
					this.selectall.replaceClass("ux-lovcombo-icon-unchecked","ux-lovcombo-icon-checked");
				}else{
					this.selectall.replaceClass("ux-lovcombo-icon-checked","ux-lovcombo-icon-unchecked")
				}
			}
		} else {
			this.clearValue()
        ...
        if(!this.list){
			...
			if(this.showSelectAll){
				this.selectall = this.list.createChild({
					cls:cls + 'item ux-lovcombo-icon-unchecked ux-lovcombo-selectall',
					html: "选择全部"
				});
				this.selectall.on("click",function(el){
					if(this.selectall.hasClass("ux-lovcombo-icon-checked")){
						this.selectall.replaceClass("ux-lovcombo-icon-checked","ux-lovcombo-icon-unchecked");
						this.deselectAll();
					}else{
						this.selectall.replaceClass("ux-lovcombo-icon-unchecked","ux-lovcombo-icon-checked")
