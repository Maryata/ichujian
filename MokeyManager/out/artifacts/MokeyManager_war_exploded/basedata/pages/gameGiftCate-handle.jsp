...
function giftList(){
	...
	// 查询非当前分类的其他所有礼包
	$.post("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getAllGameGift.action",{cid:cid,name:name,giftCate:giftCate},
		function(data){
			var json = eval("("+data+")");
			...
			if(json != 0){
				...
				// 所有礼包
				getGiftPage("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getAllGameGift.action",cid,name,giftCate);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getAllGameGift.action",{cid:cid,name:name,giftCate:giftCate},
		function(data){
...
function cateGiftList(){
	...
	// 查询当前分类的礼包总数
	$.post("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getCurrCateGift.action",{cid:cid,name:name},
		function(data){
			var json = eval("("+data+")");
			var count = json[0].count;// 数据总数
			$("#page22").empty();
			if(json != 0){
				...
				// 当前分类中的礼包
				currCateGiftPage("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getCurrCateGift.action",cid,name);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/gameGiftCateAction!getCurrCateGift.action",{cid:cid,name:name},
		function(data){
...
function submitt(){
	...
	$.post("${pageContext.request.contextPath}/basedata/gameGiftCateAction!handleCate.action",{cid:cid,gid:gid,removeGid:removeGid,order:order},function(data){
