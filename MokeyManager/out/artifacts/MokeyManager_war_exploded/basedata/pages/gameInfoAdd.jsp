...
$(function(){
	...
	KindEditor.ready(function(K) {
		window.editor_content = K.create('#depict', {
            ...
            uploadJson : "${pageContext.request.contextPath}/KindEditServlet.do?type=gameInformationShare/upload&id="+$("#newId").val(),
...
function formValid(){
	...
	if(_flag){
		...
		$("#form1").attr("action","${pageContext.request.contextPath }/basedata/gameInfoAction!saveGameInfo.action");
	}
	return _flag;
}
...
function uploadFile(btn,fileId,baseId) {
	...
	$(btn).html("uploading...");
	$.ajaxFileUpload( {
		url : "${pageContext.request.contextPath }/LogoUploadServlet.do?type=information&id="+$("#newId").val(),//用于文件上传的服务器端请求地址
