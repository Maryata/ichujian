...
function cateGameList(){
	...
	// 查询当前分类的H5游戏总数
	$.post("${pageContext.request.contextPath}/basedata/h5GameCategoryAction!getCurrCateGame.action",{cid:cid,name:name},
		function(data){
			var json = eval("("+data+")");
			var count = json[0].count;// 数据总数
			$("#page22").empty();
			if(json != 0){
				...
				// 当前分类中的H5游戏
				currCateGamePage("${pageContext.request.contextPath}/basedata/h5GameCategoryAction!getCurrCateGame.action",cid,name);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/h5GameCategoryAction!getCurrCateGame.action",{cid:cid,name:name},
		function(data){
...
function submitt(){
	...
	$.post("${pageContext.request.contextPath}/basedata/h5GameCategoryAction!handleCate.action",{cid:cid,gid:gid,removeGid:removeGid,order:order},function(data){
