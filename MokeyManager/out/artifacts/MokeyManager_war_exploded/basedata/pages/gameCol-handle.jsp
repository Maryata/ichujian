...
$(function(){
	...
	var type = $("#type").val();
	// 查询游戏总数
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getTotal.action",{cid:cid,type:type},
		function(data){
			var json = eval("("+data+")");
			if(json != 0){
				$("#gameTotal").val(json);
				// 所有游戏
				getGamePage("${pageContext.request.contextPath}/basedata/gameColAction!getGameList.action",cid,type);
			}
	});
	// 查询当前合集的游戏总数
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getTotalCol.action",{cid:cid,type:type},
		function(data){
			var json = eval("("+data+")");
			if(json != 0){
				$("#colTotal").val(json);
				// 当前合集中的游戏
				getGamePageByColId("${pageContext.request.contextPath}/basedata/gameColAction!getGamePageByColId.action",cid,type);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getGameList.action",{cid:cid,type:type},
		function(data){
			json = eval("("+data+")");
			$(json).each(function(){
				//$("#table1").append("<tr class='biaodan-q'><input type='hidden' name='GID' value="+this.C_ID+" /><td align='center'><input type='checkbox' name='ckbox1'></td><td align='center' name='GNAME'>"+this.C_NAME+"</td><td align='center' name='GSIZE'>"+this.C_SIZE+"</td></tr>");
				$("#table1").append("<tr class='biaodan-q'><input type='hidden' name='GID' value="+this.C_ID+" /><td align='center'><input type='checkbox' name='ckbox1'></td><td align='center' name='GNAME'>"+this.C_NAME+"</td></tr>");
			});
	});
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getGamePageByColId.action",{cid:cid,type:type},
		function(data){
			json = eval("("+data+")");
			$(json).each(function(){
				//$("#table2").append("<tr class='biaodan-q'><input type='hidden' name='GID' value="+this.C_ID+" /><td align='center'><input type='checkbox' name='ckbox1'></td><td align='center' name='GNAME'>"+this.C_NAME+"</td><td align='center' name='GSIZE'>"+this.C_SIZE+"</td><td align='center'><input name='CORDER' value="+this.C_ORDER+" ></input></td></tr>");
				$("#table2").append("<tr class='biaodan-q'><input type='hidden' name='GID' value="+this.C_ID+" /><td align='center'><input type='checkbox' name='ckbox1'></td><td align='center' name='GNAME'>"+this.C_NAME+"</td><td align='center'><input name='CORDER' value="+this.C_ORDER+" ></input></td></tr>");
			});
	});
});
// 分页查询所有游戏
...
function getGameCondition(){
	...
	// 条件查询游戏总数
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getTotalCondition.action",{cid:cid,name:name,minSize:minSize,maxSize:maxSize,type:type},
		function(data){
			var json = eval("("+data+")");
			$("#page11").empty();
			if(json != 0){
				$("#gameTotal").val(json);
				// 分页查询
				conditionPage("${pageContext.request.contextPath}/basedata/gameColAction!queryGameCondition.action",cid,name,minSize,maxSize,type);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!queryGameCondition.action",{cid:cid,name:name,minSize:minSize,maxSize:maxSize,type:type},
		function(data){
			json = eval("("+data+")");
			$("#table1").empty();
			$(json).each(function(){
...
function getColGameCondition(){
	...
	var type = $("#type").val();
	// 条件查询合集游戏总数
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!getColTotalCondition.action",{cid:cid,name:name,type:type},
		function(data){
			var json = eval("("+data+")");
			$("#page22").empty();
			if(json != 0){
				$("#colTotal").val(json);
				// 分页查询
				colConditionPage("${pageContext.request.contextPath}/basedata/gameColAction!queryColGameCondition.action",cid,name,type);
			}
	});
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!queryColGameCondition.action",{cid:cid,name:name,type:type},
		function(data){
			json = eval("("+data+")");
			$("#table2").empty();
			$(json).each(function(){
				//$("#table2").append("<tr class='biaodan-q'><input type='hidden' name='GID' value="+this.C_ID+" /><td align='center'><input type='checkbox' name='ckbox1'></td><td align='center' name='GNAME'>"+this.C_NAME+"</td><td align='center' name='GSIZE'>"+this.C_SIZE+"</td><td align='center'><input name='CORDER' value="+(this.C_ORDER==null?'':this.C_ORDER)+" ></input></td></tr>");
...
function submitt(){
	...
	$.post("${pageContext.request.contextPath}/basedata/gameColAction!handleCol.action",{cid:cid,gid:gid,removeGid:removeGid,order:order},function(data){
