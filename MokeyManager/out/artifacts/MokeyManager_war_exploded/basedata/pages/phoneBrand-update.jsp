...
function formValid(){
	...
	if(_flag){
		if ($("#id").val()) {
			$("#form1").attr("action","${pageContext.request.contextPath }/basedata/phoneModelAction!editBrand.action");
		} else {
			$("#form1").attr("action","${pageContext.request.contextPath }/basedata/phoneModelAction!addBrand.action");
		}
	}
	return _flag;
}
	...
	<br/>
  	<tr>
		<input type="hidden" name="id" id="id" value="${id}" />
	   	<td width="30%"  height="23" class="biaodan-top" align="left">品牌名称</td>
